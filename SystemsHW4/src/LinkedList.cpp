...
void LinkedList::printHistory(LLNode2* hp)
{
    ...
    else
    {
        ...
        while(temp->next)
        {
            ...
            outfile<<"The room number is " << room << " and the treasure subtotal is "<< treasureSubtotal << "." << std::endl;
        ...
        printf("The room was %d, and the treasure subtotal was %f.\n", room, treasureSubtotal);
        outfile<<"The room number is " << room << " and the treasure subtotal is "<< treasureSubtotal << "." << std::endl;
        printf("Total number of rooms searched was %d\n",roomsSearched);
        outfile<<"The total number of rooms searched was " <<roomsSearched<< std::endl;
        outfile.close();
